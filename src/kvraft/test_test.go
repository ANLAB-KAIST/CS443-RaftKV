...
func GenericTest(t *testing.T, part string, nclients int, unreliable bool, crash bool, partitions bool, maxraftstate int) {
	...
	title = title + " (" + part + ")" // Lab3 or Challenge2
...
func GenericTestLinearizability(t *testing.T, part string, nclients int, nservers int, unreliable bool, crash bool, partitions bool, maxraftstate int) {
	...
	title = title + ", linearizability checks (" + part + ")" // Lab3 or Challenge2
...
func TestBasicLab3(t *testing.T) {
	// Test: one client (Lab3) ...
	GenericTest(t, "Lab3", 1, false, false, false, -1)
}

func TestConcurrentLab3(t *testing.T) {
	// Test: many clients (Lab3) ...
	GenericTest(t, "Lab3", 5, false, false, false, -1)
}

func TestUnreliableLab3(t *testing.T) {
	// Test: unreliable net, many clients (Lab3) ...
	GenericTest(t, "Lab3", 5, true, false, false, -1)
}

func TestUnreliableOneKeyLab3(t *testing.T) {
	const nservers = 3
	...
	cfg.begin("Test: concurrent append to same key, unreliable (Lab3)")
...
func TestOnePartitionLab3(t *testing.T) {
	const nservers = 5
	...
	cfg.begin("Test: progress in majority (Lab3)")
	...
	cfg.begin("Test: no progress in minority (Lab3)")
	go func() {
		Put(cfg, ckp2a, "1", "15")
		done0 <- true
	}()
	...
	cfg.begin("Test: completion after heal (Lab3)")
...
func TestManyPartitionsOneClientLab3(t *testing.T) {
	// Test: partitions, one client (Lab3) ...
	GenericTest(t, "Lab3", 1, false, false, true, -1)
}

func TestManyPartitionsManyClientsLab3(t *testing.T) {
	// Test: partitions, many clients (Lab3) ...
